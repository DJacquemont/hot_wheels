...
This FSM is implemented in the function **update_motion()** in the file **motion_control.py** and is in charge of choosing which behavior to adopt to compute the update the wheels speed. Three functions are called :
